...
namespace FileExplorer
{
    public partial class Form1 : Form
    {
        ...
        private void btnFiltrele_Click(object sender, EventArgs e)
        {
            ...
            //string txt = cmbFiltre.SelectedItem.ToString();
            ...
            string sonuc = ToplamDosyaBoyutuCeviri(toplam);

            toolStripStatusLabel1.Text = string.Format("{0} adet dosya, {1} boyut", adet, sonuc);
        }

        string ToplamDosyaBoyutuCeviri(double toplam)
        {
        ...
        void DosyalariDoldur(string path)
        {
            ...
            string sonuc = ToplamDosyaBoyutuCeviri(toplamDosyaBoyutu);
